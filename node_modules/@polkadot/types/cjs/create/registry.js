...
class TypeRegistry {
    ...
    __internal__hasher = util_crypto_1.blake2AsU8a;
    __internal__knownTypes = {};
    __internal__lookup;
    __internal__metadata;
    __internal__metadataVersion = 0;
    __internal__signedExtensions = index_js_1.fallbackExtensions;
    ...
    constructor(createdAtHash) {
        this.__internal__knownDefaults = new Map(Object.entries({ Json: types_codec_1.Json, Metadata: Metadata_js_1.Metadata, PortableRegistry: index_js_4.PortableRegistry, Raw: types_codec_1.Raw, ...baseTypes }));
